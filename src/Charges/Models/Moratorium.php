...
class Moratorium
{
    public function __construct(
        ...
        if (\in_array($this->code, [MoratoriumCode::DailyAmount, MoratoriumCode::MonthlyTax]) && $this->date === null) {
    ...
    {
        if (!\in_array($this->code, [MoratoriumCode::DailyAmount, MoratoriumCode::MonthlyTax]) || $this->isNoMoratorium()) {
            return null;
        }
        return $this->date;
    }
